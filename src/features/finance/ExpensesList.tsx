...
export function ExpensesList({ selectedId, onSelect, currentMonth, onMonthChange }: ExpensesListProps) {
    ...
    return (
        <div className="h-full flex flex-col">
            {/* Header */}
            <div className="sticky top-0 z-10 bg-gradient-to-b from-background to-background/95 backdrop-blur-md p-4 space-y-4 border-b border-border/50 shadow-sm">
            ...
            <div className="flex-1 overflow-y-auto overflow-x-hidden p-4 min-w-0">
                <div className="bg-card rounded-2xl shadow-sm border border-border/60 overflow-hidden min-h-full">
                {loading ? (
