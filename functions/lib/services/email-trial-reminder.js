...
exports.getTrialReminderTemplate = void 0;
const platform_settings_1 = require("./platform-settings");
const email_templates_1 = require("./email-templates");
function getTrialReminderTemplate(data) {
    const { shopName, daysLeft, trialEndDate, upgradeUrl, settings = platform_settings_1.DEFAULT_SETTINGS } = data;
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f4f4f5;">
        <tr><td align="center" style="padding: 40px 20px;">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="w-full" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                ${(0, email_templates_1.getEmailHeader)(settings, "Trial Reminder")}
...
exports.getTrialReminderTemplate = getTrialReminderTemplate;
//# sourceMappingURL=email-trial-reminder.js.map