...
import { getEmailHeader, getEmailFooter } from "./email-templates";

export function getPublicOrderConfirmationCustomerEmail(params: {
  customerName: string;
  shopName: string;
  shopAddress?: string;
  shopPhone?: string;
  ...
  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
    <tr><td align="center" style="padding: 40px 20px;">
      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width: 600px; background: #fff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        ${getEmailHeader(settings, "Order Confirmed")}
...
export function getPublicOrderAlertShopOwnerEmail(params: {
  shopName: string;
  orderId: string;
  customerName: string;
...
<body style="margin: 0; padding: 0; background-color: #f4f4f5; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
    <tr><td align="center" style="padding: 40px 20px;">
      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width: 600px; background: #fff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        ${getEmailHeader(settings, "New Online Order")}
        <tr><td style="padding: 40px;">
