...
export default function StaffDetailScreen({
  ...
  // Delete-staff and revoke-login are omitted for the Team app — a manager can
  // edit/deactivate staff and create logins, but cannot permanently delete a
  // staff member or revoke another member's access (those stay owner-only).
