/**
 * One-off: translate en.json mobile.* to Gujarati. Writes scripts/mobile-gu.json
 * Run: node scripts/generate-mobile-gu-json.cjs
 */
...
const outPath = path.join(__dirname, "mobile-gu.json");
...
(async () => {
  ...
  fs.writeFileSync(outPath, JSON.stringify(mobileGu, null, 2) + "\n", "utf8");
